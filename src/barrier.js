...
Modes:
 • §lradius§r§c Select barrier in a radius
 • §lregion§r§c Select barrier in a region
 • §lregionEdge§r§c Select barrier in a region and draw only in the defined region`

const radiusUsage = `<radius> [block] [height]
 • §o/cs barrier radius 7
 • §o/cs barrier radius 50 cobblestone 3`

const regionUsage = `[block] [height]
 • §o/cs barrier region
 • §o/cs barrier region cobblestone 3`

const regionEdgeUsage = `[block] [height]
 • §o/cs barrier regionEdge
 • §o/cs barrier regionEdge cobblestone 3`
...
request(radius, center, (s, n) => {
  return `(way[barrier~"^wall$"](${s.join(',')},${n.join(',')});>;);out;`
}, barrier)

function barrier (data) {
